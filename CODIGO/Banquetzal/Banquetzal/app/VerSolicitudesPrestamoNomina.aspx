<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterCliente.Master" AutoEventWireup="true" CodeBehind="VerSolicitudesPrestamoNomina.aspx.cs" Inherits="Banquetzal.app.VerSolicitudesPrestamoNomina" %>
            ...
            <header class="align-center">
                ...
                <p>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="auto-style5">&nbsp;</td>
                            <td class="auto-style4">Nominas</td>
                            <td class="auto-style3">
                                <asp:DropDownList ID="nominas" runat="server" AutoPostBack="True" OnSelectedIndexChanged="nominas_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td class="auto-style2">&nbsp;</td>
                            <td class="auto-style2">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:DropDownList ID="ddlEstados" runat="server" Enabled="False" OnSelectedIndexChanged="ddlEstados_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td class="auto-style2">
