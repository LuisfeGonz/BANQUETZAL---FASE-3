...
namespace Banquetzal.ServicioWeb {
    ...
    public partial class ServicioWeb : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void descontarMontoChequeAsync(int arg0, long arg1, long arg2) {
            this.descontarMontoChequeAsync(arg0, arg1, arg2, null);
        }
        
        /// <remarks/>
        public void descontarMontoChequeAsync(int arg0, long arg1, long arg2, object userState) {
            if ((this.descontarMontoChequeOperationCompleted == null)) {
                this.descontarMontoChequeOperationCompleted = new System.Threading.SendOrPostCallback(this.OndescontarMontoChequeOperationCompleted);
            }
            this.InvokeAsync("descontarMontoCheque", new object[] {
                        arg0,
                        arg1,
                        arg2}, this.descontarMontoChequeOperationCompleted, userState);
        }
        
        private void OndescontarMontoChequeOperationCompleted(object arg) {
            if ((this.descontarMontoChequeCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.descontarMontoChequeCompleted(this, new descontarMontoChequeCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void depositarAsync(bool conCheque, int idcuenta, long idcheque, int idcuentacheque, long monto, string transaccionista, long cuiTrabajador) {
            this.depositarAsync(conCheque, idcuenta, idcheque, idcuentacheque, monto, transaccionista, cuiTrabajador, null);
        }
        
        /// <remarks/>
        public void depositarAsync(bool conCheque, int idcuenta, long idcheque, int idcuentacheque, long monto, string transaccionista, long cuiTrabajador, object userState) {
